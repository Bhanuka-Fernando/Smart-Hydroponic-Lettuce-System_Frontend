...
import WaterStatusScreen from "../screens/waterQuality/WaterStatusScreen";
import AlgaeStatusScreen from "../screens/waterQuality/AlgaeStatusScreen";
...
export type WaterQualityStackParamList = {
  ...
  WaterStatus: { tank_id: string };
  AlgaeStatus: { tank_id: string };
};
...
export default function WaterQualityNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="WaterStatus" component={WaterStatusScreen} />
      <Stack.Screen name="AlgaeStatus" component={AlgaeStatusScreen} />
